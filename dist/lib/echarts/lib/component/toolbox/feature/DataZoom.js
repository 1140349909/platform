define('node_modules/echarts/lib/component/toolbox/feature/DataZoom', function(require, exports, module) {
  ...
  'use strict';
      ...
      var history = require('node_modules/echarts/lib/component/dataZoom/history');
  
      var each = zrUtil.each;
  
      // Use dataZoomSelect
      require('node_modules/echarts/lib/component/dataZoomSelect');
      ...
      require('node_modules/echarts/lib/component/toolbox/featureManager').register('dataZoom', DataZoom);
  
  
      // Create special dataZoom option for select
      require('node_modules/echarts/lib/echarts').registerPreprocessor(function (option) {
          if (!option) {
              return;
          }
