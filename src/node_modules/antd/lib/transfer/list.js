...
var TransferList = function (_React$Component) {
    ...
    TransferList.prototype.render = function render() {
        ...
        var showItems = dataSource.map(function (item) {
            ...
            var item = _ref3.item,
                renderedText = _ref3.renderedText,
                renderedEl = _ref3.renderedEl;
            ...
            return _react2["default"].createElement(
                'li',
                { key: item.key, className: className, title: renderedText, onClick: item.disabled ? undefined : function () {
