...
var FormItem = function (_React$Component) {
    ...
    FormItem.prototype.componentDidMount = function componentDidMount() {
        if (!autoGenerateWarning && this.getControls(this.props.children, true).length > 1) {
            ...
            (0, _warning2["default"])(false, '`Form.Item` cannot generate `validateStatus` and `help` automatically, ' + 'while there are more than one `getFieldDecorator` in it.');
        }
    };
